...
| **AUTH-MET-001** | AUTH | Use-cases Auth : validation identifiants + émission tokens | **Done** | Contrats repos Auth (Domaine) | `Breizh360.Metier/Auth/AuthServiceValidateCredentials.cs`, `Breizh360.Api/Controllers/AuthController.cs`, `Breizh360.Api/Services/TokenService.cs` | L’API expose désormais les endpoints Login/Refresh/Logout en appelant le service métier. |
