...
|---|---|---|---|---|---|---|
| **INIT-AUTH-001** | Authentification / Autorisation (JWT + RBAC/ABAC) | Responsable Solution | In progress | `AUTH-REQ-001` | Publier/figer le contrat API Auth (`AUTH-REQ-001`) puis brancher l’UI (`AUTH-UI-002`) — Login UI prêt (`AUTH-UI-001`) | PR / chemins |
