...
| **INIT-NOTIF-001** | Notifications (SignalR + Inbox persistée) | Responsable Solution | Backlog | `ADR-0002` + `INIT-AUTH-001` + `NOTIF-REQ-001`..`NOTIF-REQ-005` | Contrats : OK. Data : persistance inbox livrée (`NOTIF-REQ-004`). Prochaine étape : endpoints Inbox + unread count (API) | PR / chemins |
